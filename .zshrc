...
# paths
export PATH=$HOME/.rbenv/bin:$HOME/.rbenv/shims:$HOME/bin:/usr/local/bin:/usr/local/sbin:/bin:/usr/bin:/sbin:/usr/sbin:/usr/X11R6/bin
...
if [[ $OSTYPE = darwin* ]]; then
   ...
   export PKG_PATH=http://mirror.planetunix.net/pub/OpenBSD/5.3/packages/`arch -s`/
